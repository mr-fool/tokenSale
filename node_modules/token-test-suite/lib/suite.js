...
module.exports = function (options) {
  ...
  function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee(to, amount) {
  ...
  describe('ERC-20', function () {
    describe('totalSupply()', function () {
      it('should have initial supply of ' + initialSupply.toString(),
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
      ...
      it('should return the correct supply',
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 5:
                ...
                _context5.t2 = creditIsMinting ? initialSupply.add(tokens(1)) : initialSupply;
              ...
              case 13:
                ...
                _context5.t5 = creditIsMinting ? initialSupply.add(tokens(3)) : initialSupply;
              ...
              case 21:
                ...
                _context5.t8 = creditIsMinting ? initialSupply.add(tokens(6)) : initialSupply;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 21:
                ...
                _context7.t8 = tokens(3);
                (0, _context7.t6)(_context7.t7).to.be.bignumber.equal(_context7.t8);
    ...
    describe('allowance(_owner, _spender)', function () {
      ...
      it('should have correct initial allowance',
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 8:
                ...
                _context8.t2 = expectedAllowance;
      ...
      it('should return the correct allowance',
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 33:
                ...
                _context9.t11 = tokens(4);
                (0, _context9.t9)(_context9.t10).to.be.bignumber.equal(_context9.t11);
              ...
              case 39:
                ...
                _context9.t14 = tokens(5);
                (0, _context9.t12)(_context9.t13).to.be.bignumber.equal(_context9.t14);
                _context9.t15 = expect;
                _context9.next = 45;
                return contract.allowance.call(charles, bob);

              case 45:
                _context9.t16 = _context9.sent;
                _context9.t17 = tokens(6);
                (0, _context9.t15)(_context9.t16).to.be.bignumber.equal(_context9.t17);
    ...
    describe('approve(_spender, _value)', function () {
      ...
      function describeIt(name, from, to) {
        describe(name, function () {
          it('should return true when approving 0',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should return true when approving',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should return true when updating approval',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should return true when revoking approval',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should update allowance accordingly',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
              ...
              while (1) {
                switch (_context15.prev = _context15.next) {
                  ...
                  case 13:
                    ...
                    _context15.t5 = tokens(3);
                    (0, _context15.t3)(_context15.t4).to.be.bignumber.equal(_context15.t5);
                    _context15.next = 18;
          ...
          it('should fire Approval when allowance was set to 0',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should fire Approval even when allowance did not change',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
      ...
      function _testApprovalEvent() {
        _testApprovalEvent = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee19(from, to, amount) {
          var result, log;
    ...
    describe('transfer(_to, _value)', function () {
      ...
      function describeIt(name, from, to) {
        describe(name, function () {
          it('should return true when called with amount of 0',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should return true when transfer can be made, false otherwise',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should revert when trying to transfer something while having nothing',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should revert when trying to transfer more than balance',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should not affect totalSupply',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should update balances accordingly',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should fire Transfer event when transferring amount of 0',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
      ...
      function _testTransferEvent() {
        _testTransferEvent = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee28(from, to, amount) {
          var result, log;
    ...
    describe('transferFrom(_from, _to, _value)', function () {
      ...
      it('should revert when trying to transfer while not allowed at all',
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
      ...
      it('should fire Transfer event when transferring amount of 0 and sender is not approved',
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
      ...
      function describeIt(name, from, via, to) {
        describe(name, function () {
          ...
          it('should return true when called with amount of 0 and sender is approved',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should return true when called with amount of 0 and sender is not approved',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should revert when trying to transfer something while _from having nothing',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should revert when trying to transfer more than balance of _from',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should revert when trying to transfer more than allowed',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          ...
          it('should update allowances accordingly',
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
      ...
      function _testTransferEvent2() {
        _testTransferEvent2 = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee43(from, via, to, amount) {
          var result, log;
  ...
  describe('ERC-20 optional', function () {
    ...
    describe('symbol()', function () {
      if (options.symbol != null) {
        it("should return '" + options.symbol + "'",
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
    ...
    describe('decimals()', function () {
      if (options.decimals != null) {
        it("should return '" + options.decimals + "'",
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context46.prev = _context46.next) {
                ...
                case 3:
                  ...
                  _context46.t2 = (0, _helpers.bn)(options.decimals);
  ...
  if (options.increaseDecreaseApproval) {
    describe('approvals', function () {
      describe('increaseApproval(_spender, _addedValue)', function () {
        it('should return true when increasing approval',
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
        ...
        it('should revert when approval cannot be increased',
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context49.prev = _context49.next) {
                ...
                case 5:
                  ...
                  _context49.t2 = tokens(1);
                  (0, _context49.t0)(_context49.t1).to.be.bignumber.equal(_context49.t2);
                  _context49.next = 10;
                ...
                case 10:
                  _context49.t3 = expect;
                  _context49.next = 13;
                  return contract.allowance(alice, bob);

                case 13:
                  _context49.t4 = _context49.sent;
                  _context49.t5 = tokens(3);
                  (0, _context49.t3)(_context49.t4).to.be.bignumber.equal(_context49.t5);
                  _context49.next = 18;
                ...
                case 18:
                  _context49.t6 = expect;
                  _context49.next = 21;
                  return contract.allowance(alice, bob);

                case 21:
                  _context49.t7 = _context49.sent;
                  _context49.t8 = tokens(3);
                  (0, _context49.t6)(_context49.t7).to.be.bignumber.equal(_context49.t8);
        ...
        function _testApprovalEvent2() {
          _testApprovalEvent2 = _asyncToGenerator(
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee52(from, to, fromAmount, byAmount) {
            var result;
      ...
      describe('decreaseApproval(_spender, _subtractedValue)', function () {
        ...
        it('should return true when decreasing approval',
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
        ...
        it('should return true when approval cannot be decreased',
        /*#__PURE__*/
        _asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context56.prev = _context56.next) {
                ...
                case 5:
                  ...
                  _context56.t2 = tokens(2);
                  (0, _context56.t0)(_context56.t1).to.be.bignumber.equal(_context56.t2);
                  _context56.next = 10;
                ...
                case 10:
                  _context56.t3 = expect;
                  _context56.next = 13;
                  return contract.allowance(alice, bob);

                case 13:
                  _context56.t4 = _context56.sent;
                  (0, _context56.t3)(_context56.t4).to.be.bignumber.equal(0);
                  _context56.next = 17;
                ...
                case 17:
                  _context56.t5 = expect;
                  _context56.next = 20;
                  return contract.allowance(alice, bob);

                case 20:
                  _context56.t6 = _context56.sent;
                  (0, _context56.t5)(_context56.t6).to.be.bignumber.equal(0);
        ...
        function _testApprovalEvent3() {
          _testApprovalEvent3 = _asyncToGenerator(
          /*#__PURE__*/
          regeneratorRuntime.mark(function _callee59(from, to, fromAmount, byAmount) {
            var result, log;
